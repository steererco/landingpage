...
export const Footer = (): JSX.Element => (
    <div className="flex flex-col-reverse mobile:flex-row justify-center mobile:justify-between max-w-[1444px] pb-16 mx-10 mobile:mx-20 mobile:h-[60vh] mt-[80px] mobile:mt-0">
        <LastCol />
