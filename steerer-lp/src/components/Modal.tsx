...
export const Modal = (): JSX.Element | null => {
    ...
    return (
        <>
            {context.isOpen && <></>}
            <div className="fixed scale-100 inset-0 flex justify-center items-center bg-black/[.5] z-[1]">
                <div className="flex flex-col w-[360px] h-[466px] rounded-[20px] bg-white px-6 pt-3 pb-6">
