...
export const ApplicationFunctionalities = ({ myRef }: { myRef: MutableRefObject<null> }): JSX.Element => {
    ...
    return (
        <div ref={myRef} className={`snap-start bg-white mobile:h-screen flex flex-col items-center justify-center mt-[111px] mobile:mt-0 mobile:mb-20 px-5 py-16 mobile:px-20 mobile:py-0 transition-opacity ease-in duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <TextArea />
