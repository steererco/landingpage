...
export const ImageSection = (): JSX.Element => (
    <div className="flex flex-row gap-[30px] h-screen items-center mobile:px-20 px-5">
        <div className="flex flex-1 h-[70%] flex-col gap-[30px] h-full">
            <FirstRow />
            <SecondRow />
        </div>
        <div className="flex flex-1 h-[70%] flex-row gap-[30px]">
            <div className="w-full h-full rounded-[20px] bg-gradient-to-b from-base-blue3 to-base-blue1">
